		...
		<div class = "container">
			...
			<div class = "row">
				<div class = "span12">
					...
					<ol>
						<li><a href = "<?php echo getLink(ABOUT_PAGE); ?>#whatToRead">Читайте интересные тексты</a> и&nbsp;подчёркивайте незнакомые слова.</li>
						...
						<li>Чтобы запомнить слово, достаточно повторить его несколько раз через <a href = "<?php echo getLink(ABOUT_PAGE); ?>#leitner">увеличивающиеся промежутки времени</a>. Например, через день, через три дня и&nbsp;через десять.</li>
