			...
			<div class = "row">
				<div class = "span12">
					...
					<ol>
						...
						<li>Чтобы слово запомнилось, достаточно повторить его несколько раз через <a href = "<?php echo getLink(ABOUT_PAGE); ?>#leitner">увеличивающиеся промежутки времени</a>. Например, через день, через три дня и&nbsp;через десять.</li>
