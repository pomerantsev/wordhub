			...
			<div class = "row">
				<div class = "span12">
					...
					<ol>
						...
						<li>Чтобы запомнить слово, достаточно повторить его несколько раз через <a href = "<?php echo getLink(ABOUT_PAGE); ?>#leitner">увеличивающиеся промежутки времени</a>.</li>
